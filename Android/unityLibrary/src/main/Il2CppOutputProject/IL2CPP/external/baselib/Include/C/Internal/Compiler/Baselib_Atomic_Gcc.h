...
// TODO: 64-bit WebAssembly does not currently have 128-bit atomic operations: https://github.com/WebAssembly/threads/issues/253
// The following error occurs in singlethreaded Wasm64 builds, just for the virtue of using CAS constructs there.
// LLVM/Clang will happily lower those to correct singlethreadized code, but still issue that error, so we ignore it.
// For multithreaded builds, Wasm64 will not initially be supported, but use a warning instead of an error,
// to allow to continue the work on the support easily, when the time comes.
#ifdef __EMSCRIPTEN__
#pragma clang diagnostic push
#ifdef __EMSCRIPTEN_PTHREADS__
#pragma clang diagnostic warning "-Watomic-alignment"
#endif
