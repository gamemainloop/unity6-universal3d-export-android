...
namespace baselib
{
    ...
    #undef detail_NOT_SUPPORTED
        ...
        struct atomic_base<T, true> : atomic_common<T>
        {
            ...
            FORCE_INLINE T operator=(T value) { return atomic_common<T>::operator=(value); }
        ...
        struct atomic : atomic_base<T, std::is_integral<T>::value>
        {
            ...
            FORCE_INLINE T operator=(T value) { return atomic_base<T, std::is_integral<T>::value>::operator=(value); }
        };
