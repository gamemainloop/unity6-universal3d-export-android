...
#else
MONO_PROFILER_API MonoGenericContext*
mono_class_get_context (MonoClass *klass, MonoGenericContext *storage);
#endif // !RUNTIME_IL2CPP
...
#else
MonoGenericContext*
mono_generic_class_get_context (MonoGenericClass *gclass, MonoGenericContext *storage);
#endif // !RUNTIME_IL2CPP
...
#if defined(DISABLE_REMOTING) || defined(RUNTIME_IL2CPP)
