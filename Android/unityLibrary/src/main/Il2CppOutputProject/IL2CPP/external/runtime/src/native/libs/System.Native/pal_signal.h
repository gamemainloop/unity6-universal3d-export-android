...
#ifdef FEATURE_RUNTIME_SHUTDOWN
/**
 * Uninitializes signal handling and terminal for use by System.Console and System.Diagnostics.Process.
 */
PALEXPORT void SystemNative_UninitializeTerminalAndSignalHandling(void);
#endif
